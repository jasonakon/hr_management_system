...
public class Constants {
    ...
    public static final int CSV_SALARY_INDEX = 3;
    public static final int CSV_START_DATE_INDEX = 4;

    public static final String CSV_ERROR_CODE_01 = "CSV_ERR01";
    public static final String CSV_ERROR_CODE_02 = "CSV_ERR02";
